...
const (
	...
	Group_GetGroupMsgReadState_FullMethodName              = "/openim.group.group/GetGroupMsgReadState"
)
...
type GroupClient interface {
	...
	GetGroupMsgReadState(ctx context.Context, in *GetGroupMsgReadStateReq, opts ...grpc.CallOption) (*GetGroupMsgReadStateResp, error)
}
...
func (c *groupClient) GetGroupMsgReadState(ctx context.Context, in *GetGroupMsgReadStateReq, opts ...grpc.CallOption) (*GetGroupMsgReadStateResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGroupMsgReadStateResp)
	err := c.cc.Invoke(ctx, Group_GetGroupMsgReadState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GroupServer interface {
	...
	GetGroupMsgReadState(context.Context, *GetGroupMsgReadStateReq) (*GetGroupMsgReadStateResp, error)
...
func (UnimplementedGroupServer) GetGroupMsgReadState(context.Context, *GetGroupMsgReadStateReq) (*GetGroupMsgReadStateResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetGroupMsgReadState not implemented")
}
...
func _Group_GetGroupMsgReadState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGroupMsgReadStateReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GroupServer).GetGroupMsgReadState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Group_GetGroupMsgReadState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GroupServer).GetGroupMsgReadState(ctx, req.(*GetGroupMsgReadStateReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Group_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetGroupMsgReadState",
			Handler:    _Group_GetGroupMsgReadState_Handler,
		},
	},
