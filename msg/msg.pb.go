...
func (x *SendPushMsgReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendPushMsgReq) ProtoMessage() {}

func (x *SendPushMsgReq) ProtoReflect() protoreflect.Message {
	mi := &file_msg_msg_proto_msgTypes[81]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendPushMsgReq.ProtoReflect.Descriptor instead.
func (*SendPushMsgReq) Descriptor() ([]byte, []int) {
...
func (x *SendPushMsgResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendPushMsgResp) ProtoMessage() {}

func (x *SendPushMsgResp) ProtoReflect() protoreflect.Message {
	mi := &file_msg_msg_proto_msgTypes[82]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
const file_msg_msg_proto_rawDesc = "" +
	...
	"\x0eGetLastMessage\x12\x1d.openim.msg.GetLastMessageReq\x1a\x1e.openim.msg.GetLastMessageResp\x12F\n" +
	"\vSendPushMsg\x12\x1a.openim.msg.SendPushMsgReq\x1a\x1b.openim.msg.SendPushMsgRespB#Z!github.com/openimsdk/protocol/msgb\x06proto3"
...
var file_msg_msg_proto_goTypes = []any{
	...
	(*SendPushMsgReq)(nil),                       // 81: openim.msg.SendPushMsgReq
	(*SendPushMsgResp)(nil),                      // 82: openim.msg.SendPushMsgResp
...
var file_msg_msg_proto_depIdxs = []int32{
	...
	81,  // 74: openim.msg.msg.SendPushMsg:input_type -> openim.msg.SendPushMsgReq
	101, // 75: openim.msg.msg.GetMaxSeq:output_type -> openim.sdkws.GetMaxSeqResp
	...
	102, // 80: openim.msg.msg.PullMessageBySeqs:output_type -> openim.sdkws.PullMessageBySeqsResp
	...
	64,  // 102: openim.msg.msg.DestructMsgs:output_type -> openim.msg.DestructMsgsResp
	72,  // 103: openim.msg.msg.GetActiveConversation:output_type -> openim.msg.GetActiveConversationResp
	74,  // 104: openim.msg.msg.SetUserConversationMaxSeq:output_type -> openim.msg.SetUserConversationMaxSeqResp
	...
	82,  // 108: openim.msg.msg.SendPushMsg:output_type -> openim.msg.SendPushMsgResp
